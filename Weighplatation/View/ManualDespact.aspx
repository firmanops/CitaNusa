<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManualDespact.aspx.cs" Inherits="Weighplatation.View.ManualDespact" %>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-100px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <h4 class="text-blue h4">Manual Despact</h4>
                    </div>
                    <div class="wizard-content">
                        <formview runat="server">
                            <asp:UpdatePanel ID="updatepnl" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <dx:BootstrapComboBox ID="txtContract" runat="server" DataSourceID="SqlDataSourceContract" 
                                                ...
                                                <Items>
                                                    <dx:BootstrapListEditItem Text="" Value="" Selected="true" />                                                    
                                                </Items>                                                                                          
                                ...
                                <div class="row>">                                                                       
                                    <div class="col-md-12">
                                        <asp:SqlDataSource ID="SqlDataDespact" runat="server" ConnectionString="<%$ ConnectionStrings:ILGDbConn %>" ProviderName="<%$ ConnectionStrings:ILGDbConn.ProviderName %>" 
                                            SelectCommand="select &quot;ContractNo&quot;  from public.&quot;WBTRX&quot; where &quot;WBStatus&quot; ='F'  and &quot;WBType&quot; ='Despact'"></asp:SqlDataSource>
                                        <dx:BootstrapGridView ID="grid" runat="server"  KeyFieldName="TicketNo" Width="100%" AutoGenerateColumns="false" OnDataBinding="grid_DataBinding">
                                            ...
                                            <Columns>
                                                 <dx:BootstrapGridViewDataColumn Width="250px" CssClasses-HeaderCell="centerText" Caption="Action" VisibleIndex="0" HorizontalAlign="Center">                                                    
                                                    <DataItemTemplate>
                                                        <asp:HyperLink Visible='<%# Eval("WBStatus").ToString() == "Complete" || Eval("WBStatus").ToString() == "Second" ? false : true %>'   CssClass="btn btn-info" runat="server" NavigateUrl='<%# string.Format("ManualDespactSecond.aspx?Ticket={0}",
															HttpUtility.UrlEncode(Eval("TicketNo").ToString())) %>'>Weight 2nd</asp:HyperLink>                                                       
                                                        <asp:HyperLink Visible='<%# Eval("WBStatus").ToString() == "First" ? false : true %>'  CssClass="btn btn-warning" runat="server" NavigateUrl='<%# string.Format("DespactView.aspx?Ticket={0}",
															HttpUtility.UrlEncode(Eval("TicketNo").ToString())) %>'>View</asp:HyperLink>
                                                        <asp:HyperLink Visible='<%#   Session["Approval"].ToString() == "true" && Eval("WBStatus").ToString() == "Second" ? true : false%>' CssClass="btn btn-success" runat="server" NavigateUrl='<%# string.Format("DespactEdit.aspx?Ticket={0}",
