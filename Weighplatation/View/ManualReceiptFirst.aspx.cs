...
{
    public partial class ManualReceiptFirst : System.Web.UI.Page
    {
        DataSet ds = null;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txtTransactionDate.Text == "") {
                    err = "Transaction Date is required !!!";
                    MessageError(this, err, "Error");
                }
                ...
                if (err == "")
                {
                    ...
                    _WBTRXModel.TrxDateIn = Convert.ToDateTime(txtTransactionDate.Text +" "+ s);
