<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManualDespactSecond.aspx.cs" Inherits="Weighplatation.View.ManualDespactSecond" %>
                                                                                            ...
                                                                                            <SettingsCommandButton>
                                                                                                ...
                                                                                                <dx:BootstrapGridViewCommandColumn Caption="Action" ShowDeleteButton="True" ShowEditButton="True" ShowNewButtonInHeader="true" VisibleIndex="1"></dx:BootstrapGridViewCommandColumn>
                                                                                                    <dx:BootstrapGridViewComboBoxColumn  Caption="Mutu" FieldName="GradingTypeID"  Visible="true" VisibleIndex="2">
                                                                                                     ...
                                                                                                     <dx:BootstrapGridViewTextColumn Caption="UOM ID" FieldName="UomID" VisibleIndex="3" Visible="false">                                                                                                
                                                                                                        <EditItemTemplate>
                                                                                                            <dx:BootstrapTextBox ID="UomID"  runat="server"></dx:BootstrapTextBox>
                                                                                                         <%--   <dx:ASPxHiddenField ID="UomID" runat="server"></dx:ASPxHiddenField>--%>
                                                                                                        </EditItemTemplate>
                                                                                                    </dx:BootstrapGridViewTextColumn>
                                                                                                    <dx:BootstrapGridViewTextColumn Caption="UOM Name" FieldName="UomName" VisibleIndex="4" Visible="false">                                                                                                
                                                                                                        <EditItemTemplate>
                                                                                                            <dx:BootstrapTextBox ID="UomName"  runat="server"></dx:BootstrapTextBox>
                                                                                                           <%-- <dx:ASPxHiddenField ID="UomID" runat="server"></dx:ASPxHiddenField>--%>
                                                                                                        </EditItemTemplate>
                                                                                                    </dx:BootstrapGridViewTextColumn>
                                                                        ...
                                                                        <td class="p-sm-3">
                                                                            <div class="align-bottom">
                                                                                <dx:BootstrapButton runat="server" ID="btnPrint" Text="Print" OnClick="btnPrint_Click">
                                                                                    <SettingsBootstrap RenderOption="Primary" />
                                                                                    <ClientSideEvents Click="SetTargetD2()" />
                                                                                </dx:BootstrapButton>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
