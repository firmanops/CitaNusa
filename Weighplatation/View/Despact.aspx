<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Despact.aspx.cs" Inherits="Weighplatation.View.Despact" %>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-100px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <h4 class="text-blue h4">Despacth</h4>
                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <%--<dx:BootstrapComboBox ID="txtContract" runat="server" DataSourceID="SqlDataSourceContract" 
                                                ...
                                                <Items>
                                                    <dx:BootstrapListEditItem Text="" Value=""/>                                                    
                                                </Items>                                                                                          
                                        ...
                                        <dx:BootstrapGridView ID="grid" runat="server"  KeyFieldName="TicketNo" Width="100%" AutoGenerateColumns="false" OnDataBinding="grid_DataBinding">
                                            ...
                                            <Columns>
                                                <dx:BootstrapGridViewDataColumn  Width="250px"  CssClasses-HeaderCell="centerText" Caption="Action" VisibleIndex="0" HorizontalAlign="Center">                                                    
                                                    <DataItemTemplate>
                                                        <asp:HyperLink Visible='<%# Eval("WBStatus").ToString() == "Complete" || Eval("WBStatus").ToString() == "Second" ? false : true %>'   CssClass="btn btn-info" runat="server" NavigateUrl='<%# string.Format("DespactSecond.aspx?Ticket={0}",
