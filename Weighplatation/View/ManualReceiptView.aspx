<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManualReceiptView.aspx.cs" Inherits="Weighplatation.View.ManualReceiptView" %>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-100px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <h4 class="text-blue h4">Manual Receipt 2nd</h4>
                    </div>
                                            ...
                                            <div class="card card-box w-100">
                                                <div class="card-body w-100">                                                              
                                                    <table border="0" cellpadding="0" cellspacing="1" width="100%">
                                                        <tr align="center">
                                                            <th align="center"><u>Manual Receipt 1st</u></th>
                                                            <th></th>
                                                        </tr>
                                                        <tr>
                                                            <td align="center">
                                    ...
                                    <div class="col-lg-4 d-flex align-items-stretch">
                                            <div class="card card-box w-100 ">
                                                <div class="card-body w-100">
                                                    <table border="0" cellpadding="0" cellspacing="1" width="100%">
                                                        <tr align="center">
                                                            <th align="center"><u>Manual Receipt 2nd</u></th>
                                                            <th></th>
                                                        </tr>
                                                        <tr>
                                                            <td align="center">
