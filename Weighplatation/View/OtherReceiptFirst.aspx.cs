...
{
    public partial class OtherReceiptFirst : System.Web.UI.Page
    {
        DataSet ds = null;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (err == "")
                {
                    ...
                    _WBTRXModel.ProductCode = ddlItem.Value.ToString();                                      
                    ...
                    result = _receiptRepo.InsertOtherReceiptHeader(_WBTRXModel, _WBTRXBLOCK);

                    if (result)
                    {
                        MessageSuccess(this, "success", "Success!");
                        refreshObject();
                        Response.Redirect("/View/OtherReceipts.aspx");
                    }
                    else
                    {
