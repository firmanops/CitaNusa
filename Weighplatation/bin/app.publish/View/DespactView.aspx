<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DespactView.aspx.cs" Inherits="Weighplatation.View.DescpatView" %>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-100px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <h4 class="text-blue h4">Despacth View</h4>
                    </div>
                      ...
                      <%--  <formview runat="server">--%>
                                                    ...
                                                    <div class="card card-box w-100">
                                                        <div class="card-body w-100">                                                              
                                                            <table border="0" cellpadding="0" cellspacing="1" width="100%">
                                                                <tr align="center">
                                                                    <th align="center"><u>Despacth 1st</u></th>
                                                                    <th></th>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center">
                                            ...
                                            <div class="col-lg-4 d-flex align-items-stretch">
                                                    <div class="card card-box w-100 ">
                                                        <div class="card-body w-100">
                                                            <table border="0" cellpadding="0" cellspacing="1" width="100%">
                                                                <tr align="center">
                                                                    <th align="center"><u>Despacth 2nd</u></th>
                                                                    <th></th>
                                                                </tr>
                                                                <tr>
                                                                    <td align="center">
                            ...
                            <section>
                                                ...
                                                <div class="pd-20 card-box mb-30">                                        
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class=" col-lg-6 form-group row">
							                                    ...
							                                    <div class="col-sm-12 col-md-9">
                                                                    <dx:BootstrapTextBox ID="txtDelivery" NullText="Delivery Order..."  runat="server" ReadOnly="true">                                                           
                                                                    </dx:BootstrapTextBox>
                                                                    <dx:BootstrapTextBox ID="txtDnNo" NullText="Delivery Order..."  runat="server" Visible="false">                                                           
                                                                    </dx:BootstrapTextBox>
							                                    </div>
                                                            </div>                                                        
                                                        </div>
                                                            ...
                                                            <div class=" col-lg-6 form-group row">
                                                                ...
                                                                <div class="col-sm-10 col-md-9">
                                                                    <dx:BootstrapTextBox ID="txtUnit" NullText="Unit..."  runat="server" ReadOnly="true">                                                           
                                                                     ...
                                                                     <dx:BootstrapTextBox ID="txtUnitCode" NullText="Unit..."  runat="server" Visible="false">                                                           
                                                                    </dx:BootstrapTextBox>    
                                                                </div>
                                                            </div>
                                                            <div class=" col-lg-6 form-group row">
                                                        ...
                                                        <div class="col-md-12">                                                                  
                                                            <dx:BootstrapPageControl  runat="server" TabAlign="Justify" ActiveTabIndex="0">
                                                                            <TabPages>
                                                                                            ...
                                                                                            <dx:BootstrapGridView ID="griddetail2nd" 
                                                                                                ...
                                                                                                <SettingsCommandButton>
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <dx:BootstrapGridViewTextColumn Caption="Quantity" FieldName="Quantity" VisibleIndex="4">
                                                                                                             <PropertiesTextEdit DisplayFormatString="###,###.##;-#.#;0" ></PropertiesTextEdit>
                                                                                                        </dx:BootstrapGridViewTextColumn>
                                                                                                         <dx:BootstrapGridViewTextColumn Caption="No. Segel 1" FieldName="NoSegel1" VisibleIndex="5">                                                                                                
                                                                                                        </dx:BootstrapGridViewTextColumn>
                                                                                                         <dx:BootstrapGridViewTextColumn Caption="No. Segel 2" FieldName="NoSegel2" VisibleIndex="6">                                                                                                
                                                                                                        </dx:BootstrapGridViewTextColumn>                                                                                            
                                                                                                </Columns>                                                                                             
                                                                                ...
                                                                                <dx:BootstrapTabPage Text="NET Weigh" ActiveTabIconCssClass="fa fa-check">
                                                                                    <ContentCollection>
                                                                                        <dx:ContentControl runat="server" SupportsDisabledAttribute="True">
                                                                                            <dx:BootstrapGridView ID="griddetailnet" runat="server"   KeyFieldName="ID">                                                                                   
                                                                                                <SettingsDataSecurity AllowDelete="false" AllowEdit="False" AllowInsert="False" />
                                                                                                    ...
                                                                                                    <Columns>
                                                                                                        ...
                                                                                                        <dx:BootstrapGridViewTextColumn Caption="Weigh" FieldName="WeightHeavy" VisibleIndex="5">
                                                                                                             <PropertiesTextEdit DisplayFormatString="###,###.##;-#.#;0" ></PropertiesTextEdit>
                                                                                                        </dx:BootstrapGridViewTextColumn>                                                                                         
                                                                                                </Columns>                                                                               
                                                                                                <Templates>
                                            ...
                                            <div class="float-right">
                                                <table style="text-align:left">
                                                    <tr style="text-align:left">
                                                        ...
                                                        <td class="p-sm-3">
                                                            <div class="align-bottom">
                                                                <dx:BootstrapButton runat="server" ID="btnPrints" Text="Print" OnClick="btnPrint_Click">
                                                                    <SettingsBootstrap RenderOption="Primary" />
                                                         ...
                                                         <td class="p-sm-3">
                                                               <div class="align-bottom">
                                                                    <dx:BootstrapButton runat="server" ID="btnComplete" OnClick="btnComplete_Click" Text="Completed" >
                                ...
                                <asp:SqlDataSource ID="SqlDataSourceGrading" runat="server" ConnectionString="<%$ ConnectionStrings:ILGDbConn %>" ProviderName="<%$ ConnectionStrings:ILGDbConn.ProviderName %>" 
                                    SelectCommand="select &quot;GradingTypeID&quot; , &quot;GradingTypeID&quot; ||'-'|| &quot;GradingName&quot;  as GradingName from public.&quot;WBGRADINGTYPE&quot;;"> 
                                </asp:SqlDataSource>
                            </section>
                        <%--</formview>--%>
                    </div>
