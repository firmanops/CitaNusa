<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReceiptView.aspx.cs" Inherits="Weighplatation.View.ReceiptView" %>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-100px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <h4 class="text-blue h4">Receipt View</h4>
                    </div>
                    ...
                    <section>
                        <formview>
                            <asp:UpdatePanel ID="updatepnl" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">  
                                ...
                                <%-- <Triggers>
                                    <asp:PostBackTrigger ControlID="btnSend" EventName="Click" />
                                </Triggers>--%>
                                <ContentTemplate>
                                    <div class="pd-20 card-box mb-30">										                                                            
                                        <div class="row">                                                
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-body">
                                                    <div class="spinner-border text-primary" role="status">
                                                        <span class="sr-only">Process Synchronize wait...</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
