<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManualReceiptFirst.aspx.cs" Inherits="Weighplatation.View.ManualReceiptFirst" %>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-100px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <h4 class="text-blue h4">ManualReceipt 1st</h4>
                    </div>
                                    ...
                                    <section>                        
						                ...
						                <div class="row">
                                             <div class=" col-lg-6 form-group row">
                                                ...
                                                <div class="col-sm-12 col-md-9">
                                                    ...
                                                    <asp:SqlDataSource ID="SqlDataSourceContract" runat="server" ConnectionString="Server=localhost;port=5432;Database=plantation;User Id=postgres;Password=root;" ProviderName="<%$ ConnectionStrings:ILGDbConn.ProviderName %>"
                                        ...
                                        <div class="row">
                                            <div class=" col-lg-6 form-group row">
							                    ...
							                    <div class="col-sm-12 col-md-9">                                           
								                    <dx:BootstrapComboBox ID="ddlUnit" AutoPostBack="true"   OnSelectedIndexChanged="ddlUnit_SelectedIndexChanged"  TextField="UnitName" ValueField="UnitCode" runat="server">
                                                        <Items>
                                                            <dx:BootstrapListEditItem Text="" Value="" Selected="true"></dx:BootstrapListEditItem>
                                                        </Items>                                                           
                                                        <ValidationSettings ValidationGroup="Validation">
                                                    ...
                                                    <asp:SqlDataSource ID="SqlDataSourceUnit" runat="server" ConnectionString="Server=localhost;port=5432;Database=plantation;User Id=postgres;Password=root;" ProviderName="<%$ ConnectionStrings:ILGDbConn.ProviderName %>"
                                           ...
                                           <div class=" col-lg-6 form-group row">
							                    <label class="col-sm-12 col-md-3 col-form-label">Product</label>
                                                    <div class="col-sm-10 col-md-9">
                                                        ...
                                                        <%--<dx:BootstrapComboBox  class="form-control" ID ="ddlItem" runat="server" ValueField="ProductCode" TextField="ProductName">
                                                            <Items>
                                                                <dx:BootstrapListEditItem Text="" Value="" Selected="true"></dx:BootstrapListEditItem>
                                                            </Items>
                                                            <ValidationSettings ValidationGroup="Validation">
                                                    ...
                                                    SelectCommand="select a.&quot;BPCode&quot;, a.&quot;ProductCode&quot;,b.&quot;ProductName&quot;  from  public.&quot;WBCONTRACT&quot; a
	                                                                inner join public.&quot;WBPRODUCT&quot; b on  a.&quot;ProductCode&quot; =b.&quot;ProductCode&quot; "></asp:SqlDataSource>--%>
						                    </div>
                                            <div class=" col-lg-6 form-group row">
                                                <label class="col-sm-12 col-md-3 col-form-label">Transaction Date</label>
                                                <div class="col-sm-12 col-md-9">
                                                    <dx:BootstrapDateEdit ID="txtTransactionDate" DisplayFormatString="dd-MM-yyyy" NullText="Select Date" runat="server">
                                        ...
                                        <div class="row">                                           
                                            ...
                                            <div class=" col-lg-6 form-group row">
                                                ...
                                                <div class="col-sm-12 col-md-9">
                                                    <dx:BootstrapTextBox ID="txtReason" NullText="Reason..."  runat="server">
                                                        <ValidationSettings ValidationGroup="Validation">
