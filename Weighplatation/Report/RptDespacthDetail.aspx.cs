...
{
    public partial class RptDespacthDetail : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                string Ext = "";
                string FileName = "";
                List<RptDespacthDtlModel> lt = new List<RptDespacthDtlModel>();
                ...
                {
                    lt = _context.Items["ls"] as List<RptDespacthDtlModel>;
                }
                ...
                rptReportDespacth report = new rptReportDespacth();
        ...
        private void ExportReport(rptReportDespacth report, string fileName, string ext, bool inline)
        {
