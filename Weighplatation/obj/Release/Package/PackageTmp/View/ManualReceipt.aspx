<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ManualReceipt.aspx.cs" Inherits="Weighplatation.View.ManualReceipt" %>
        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-100px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <h4 class="text-blue h4">Manual Receipt</h4>
                    </div>
                                             ...
                                             <Settings ShowHeaderFilterButton="True" />
                                                <Columns>
                                                 <dx:BootstrapGridViewDataColumn Width="250px" CssClasses-HeaderCell="centerText" Caption="Action"  VisibleIndex="0" HorizontalAlign="Center">                                                    
                                                    <DataItemTemplate>
                                                        <asp:HyperLink Visible='<%# Eval("WBStatus").ToString() == "Complete" || Eval("WBStatus").ToString() == "Second" ? false : true %>'  CssClass="btn btn-info" runat="server" NavigateUrl='<%# string.Format("ManualReceiptSecond.aspx?Ticket={0}",
